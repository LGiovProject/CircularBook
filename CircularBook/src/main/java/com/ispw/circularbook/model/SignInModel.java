...
public class SignInModel {
        ...
        public SignInModel(String email, String password, String repassword, String nomeLib, String via, City citta, int nTel) throws WrongEmailFormattException, NoMatchPasswordException, PasswordCampRequiredException, CityCampRequiredException {
            this.setEmail(email);
        ...
        public SignInModel(String email,String username,String password,String repassword, String nome, String cognome, City citta) throws WrongEmailFormattException, NoMatchPasswordException, PasswordCampRequiredException, CityCampRequiredException {
            this.setEmail(email);
